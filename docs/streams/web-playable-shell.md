...
This is the fixture implementation description; the [README](../../README.md#walking-skeleton-setup) owns current scope and the [shared product contract](../product.md) owns product decisions and limitations.
