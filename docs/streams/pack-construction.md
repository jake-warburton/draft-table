...
This is the build-time implementation description; [shared collation documentation](../rules-and-collation.md#complete-identity-only-pack-construction) owns the accepted behavior, evidence attribution, and limitations.
...
Private four-source acceptance passed for exact head `aa825b18b5c455d253af9c0c45842b0b21a4d4bd`: the durable authority is the captain's PR 66 comment plus merge (20/20 and green CI; squash `bfda2d97104312d4276523ff23f683b296747b22`).
