...
This is the package's implementation description; [the shared domain model](../domain-model.md#implemented-pure-draft-runtime) owns product decisions and integration limitations.
