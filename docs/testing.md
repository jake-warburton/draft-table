...
- The scaffold builds the completed client and reports actual client and server bundle sizes without a client-size gate; the server remains under the 3 MB Free limit [CF-1].
