...
- accept the real recipe/upstream rarity, pool-identity, and weighted-layout resolution results, then select reviewed physical treatments for those resolved identities;
