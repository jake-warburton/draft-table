...
- accept the real recipe/upstream rarity, pool-identity, weighted-layout resolution, collation-weight table, bounded-ticket lookup, and one-sample composition results, then select reviewed physical treatments for those resolved identities;
