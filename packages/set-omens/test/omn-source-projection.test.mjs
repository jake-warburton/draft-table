...
const sourceCard = (overrides = {}) => ({ unique_id: "card-1", name: "Fictional", printings: [sourcePrinting()], ...overrides });
const fixtureSchema = {
...
test("OMN projection exactly filters mixed-set printings, maps source fields, and preserves source order", () => {
  ...
  assert.deepEqual(result, [
    { unique_id: "card-b", name: "Second", printings: [{ unique_id: "p-b", set_printing_unique_id: "set-printing-1", id: "2", set_id: "OMN", edition: "First Edition", foiling: "Rainbow Foil", rarity: "Common", expansion_slot: false, image_url: "https://images.example.invalid/card.jpg" }] },
    { unique_id: "card-a", name: "First", printings: [
