...
const p = (id, unique_id, foiling) => ({ unique_id, set_printing_unique_id: id.startsWith("IAR") ? "sp-iar" : "sp-omn", id, set_id: id.slice(0, 3), edition: "e", foiling, rarity: "r", expansion_slot: false, image_url: "https://images.example.invalid/a", art_variations: [] });
const c = (unique_id, printings) => ({ unique_id, name: "Fictional", pitch: "", printings });
const source = () => [
