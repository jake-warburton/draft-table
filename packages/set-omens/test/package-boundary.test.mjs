...
test("external build-time consumers can import only the schema-validation subpath when dependencies are installed", () => {
  ...
  assert.equal(result.status, 0, result.stderr);
  assert.equal(result.stdout.trim(), "function function function function function function function function function function function function function function");
});
